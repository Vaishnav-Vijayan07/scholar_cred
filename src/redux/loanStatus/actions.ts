...
// common success
export const LoanStatusApiResponseSuccess = (actionType: string, data: StatusData | {}): LoanStatusActionType => ({
  type: LoanStatusActionTypes.API_RESPONSE_SUCCESS,
  payload: { actionType, data },
});
// common error
export const LoanStatusApiResponseError = (actionType: string, error: string): LoanStatusActionType => ({
...
export const addLoanStatus = (status_name: string, status_description: string): LoanStatusActionType => ({
...
export const updateLoanStatus = (id: string, status_name: string, status_description: string): LoanStatusActionType => ({
