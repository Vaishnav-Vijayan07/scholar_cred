export enum ConsultantStaffActionTypes {
    API_RESPONSE_SUCCESS = "@@consultant_staffs/API_RESPONSE_SUCCESS",
    API_RESPONSE_ERROR = "@@consultant_staffs/API_RESPONSE_ERROR",
    CREATE_CONSULTANT_STAFF = "@@consultant_staffs/CREATE_CONSULTANT_STAFF",
